...
describe Subscriber, elasticsearch: true do
  ...
  it "generates a correct filter_test GET query with specified fields" do
    ...
    callback_query = "http://subscriber/cdp_trigger?patient%5Bgender%5D=male&test%5Bassays%5D%5B%5D%5Bcondition%5D=mtb&test%5Bassays%5D%5B%5D%5Bname%5D=mtb&test%5Bassays%5D%5B%5D%5Bresult%5D=positive"
