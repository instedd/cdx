...
describe Subscriber, elasticsearch: true do
  ...
  it "generates a correct filter_test POST query with all fields" do
    ...
    assert_requested(:post, url) do |req|
      ...
      expect(response["sample"].keys).to match_array(["uuid", "id", "type", "collection_date", "is_quality_control", "isolate_name", "production_date", "inactivation_method", "volume", "lab_technician"])
