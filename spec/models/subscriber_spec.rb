...
describe Subscriber do
  ...
  it "generates a correct filter_event POST query with all fields" do
    ...
    assert_requested(:post, url) do |req|
      JSON.parse(req.body).keys.should =~ ["age","assay_name","condition","created_at","device_serial_number","device_uuid","error_code","error_description","ethnicity","event_id","gender","institution_id","laboratory_id","location","patient_id","patient_name","patient_telephone_number","patient_zip_code","race","race_ethnicity","result","start_time","status","system_user","test_type","updated_at","uuid"]
    end
  end
