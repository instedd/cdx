...
describe Subscriber, elasticsearch: true do
  ...
  it "generates a correct filter_test POST query with all fields" do
    ...
    assert_requested(:post, url) do |req|
      ...
      expect(response["sample"].keys).to match_array(["uuid", "id", "type", "collection_date", "specimen_role", "isolate_name", "date_produced", "inactivation_method", "volume", "lab_technician", "old_batch_number", "virus_lineage", "concentration", "replicate", "media", "measured_signal", "measurement_result"])
