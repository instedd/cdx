...
describe "create encounter" do
  ...
  xit "should search sample by id substring" do
  ...
  xit "should search test by id substring" do
  ...
  xit "should add sample to encounter on save" do
    process sample: {id: "ab111"}
  ...
  xit "should add test to encounter on save" do
    process test: {id: "ab111"}
  ...
  xit "should create patient when adding test with information" do
  ...
  xit "should merge patient information coming from different tests" do
    process test: {id: "ab123"}, patient: {name: "John Doe"}
  ...
  xit "should be able to change the assay result and quantity of encounter" do
    process test: {id: "a"}
  ...
  xit "adding test to existing sample should leave new test in encounter" do
    process sample: {id: "s"}
  ...
  xit "should be able to create fresh encounter with existing patient" do
  ...
  xit "should be able to create fresh encounter with new patient" do
    goto_page NewFreshEncounterPage do |page|
