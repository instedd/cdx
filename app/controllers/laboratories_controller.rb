class LaboratoriesController < ApplicationController
  ...
  def index
    @laboratories = authorize_resource(@institution.laboratories, "cdpx:readLaboratory")
  end
  ...
  def edit
    ...
    return unless authorize_resource(@laboratory, "cdpx:updateLaboratory")
  ...
  def destroy
    @laboratory = @institution.laboratories.find params[:id]
    return unless authorize_resource(@laboratory, "cdpx:deleteLaboratory")
