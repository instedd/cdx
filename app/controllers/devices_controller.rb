class DevicesController < ApplicationController
  ...
  def index
    @devices = authorize_resource(@institution.devices, "cdpx:readDevice")
  end
  ...
  def create
    ...
    return authorize_resource(@device, "cdpx:createDevice")
  ...
  def edit
    ...
    return authorize_resource(@device, "cdpx:updateDevice")
  ...
  def destroy
    @device = @institution.devices.find params[:id]
    return authorize_resource(@device, "cdpx:deleteDevice")
  ...
  def regenerate_key
    @device = @institution.devices.find params[:id]
    return authorize_resource(@device, "cdpx:regenerateDeviceKey")
  ...
  def load_institution
    ...
    authorize_resource(@institution, "cdpx:readInstitution")
  end
