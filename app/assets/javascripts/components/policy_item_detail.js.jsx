    ...
    return (
      <div>
        ...
        <div>
          ...
          <input type="checkbox" id="includeSubsites" checked={this.props.statement.includeSubsites} onChange={this.props.toggleIncludeSubsites} />
          <label htmlFor="includeSubsites">Include subsites</label>
        </div>
      </div>
    );
  },
